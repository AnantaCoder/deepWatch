...
<div style={{ 
  ...
  paddingRight: isMobile ? '0' : '4rem' // <--- Add this line
          ...
          <div style={{ lineHeight: 1 }}>
            <div style={{
              fontSize: isMobile ? 'clamp(3.5rem, 18vw, 5.5rem)' : 'clamp(4rem, 11vw, 9rem)',
              fontWeight: 900,
              textTransform: 'uppercase',
              WebkitTextStroke: isMobile ? '2px #000' : '3px #000',
              color: 'transparent',
              lineHeight: 1,
            }}>CATCH</div>
            ...
            <div style={{ lineHeight: 1.05, margin: '0.1em 0' }}>
              <span style={{
                ...
                boxShadow: isMobile ? '5px 5px 0px 0px #000' : '8px 8px 0px 0px #000',
                lineHeight: 1.05,
              }}>THE</span>
            </div>
          ...
          {/* Stats */}
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: isMobile ? '0.75rem' : '1.5rem', marginTop: isMobile ? '0.75rem' : '1.5rem' }}>
            {[['98.2%', 'ACCURACY'], ['3', 'MODALITIES'], ['<2S', 'PER SCAN']].map(([val, lbl]) => (
              <div key={lbl} style={{
                ...
                boxShadow: '4px 4px 0px 0px #000',
                textAlign: 'center',
                flex: isMobile ? '1 1 calc(33% - 0.75rem)' : 'unset',
                minWidth: isMobile ? '80px' : '90px',
              }}>
                <div style={{ fontSize: isMobile ? '1.75rem' : '2.25rem', fontWeight: 900, lineHeight: 1 }}>{val}</div>
        ...
        {/* RIGHT — Visual Chaos Zone (hidden on mobile to keep things clean) */}
        {!isMobile && (
